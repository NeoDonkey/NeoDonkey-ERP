...
| **DATEV EXTF v700** | ✅ Full serializer with tests | ⚠️ Community module | ❌ Third-party | ⚠️ Export only |
| **XRechnung XML** | ✅ Native generator | ⚠️ Module | ❌ Third-party | ⚠️ Export only |
...
npm test                       # the full test suite (about 30 seconds)
